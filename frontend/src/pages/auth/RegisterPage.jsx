...
import { useSignUp, useUser as useClerkUser, useClerk } from '@clerk/clerk-react';
...
export default function RegisterPage() {
  ...
  // After Clerk Google sign-up completes (redirect back), sync with Laravel backend
  useEffect(() => {
      ...
      <div className="flex items-center justify-center px-4 mt-4">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-xl shadow-gray-200/50 p-8 border border-gray-100">
          ...
          <button
            ...
            disabled={googleLoading || !signUpLoaded}
